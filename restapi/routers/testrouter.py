...
from repository.teststudentrepository import update_test_student
...
async def add_test(test: Test, user: User = Depends(current_active_user)):
    ...
    new_test = {"id": test_id, "user_id": str(user.id), "jump": test.jump}
...
async def get_tests(test_id: str):
    ...
    if test_found.open == False:
        ...
        test_found = {"questions": [], "jump": test_found.jump}
