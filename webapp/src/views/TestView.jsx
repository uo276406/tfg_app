...
function TestView() {
  ...
  const handleSetStudentCombination = (studentCombination) => {
    setStudentCombination(studentCombination);
  };
    ...
    const steps = {
      0: (
        <JoinTestForm
          ...
          handleSetTestInfo={handleSetTestInfo}
          handleSetStudentCombination={handleSetStudentCombination}
        />
      ),
      1: (
        <Test
